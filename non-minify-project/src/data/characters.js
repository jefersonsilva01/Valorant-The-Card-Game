const characters = [
  {
    ...
    avatar: "./assets/images/brimstone-avatar.png",
    avatarHover: "./assets/images/brimstone-avatar-hover.png",
...

  {
    ...
    avatar: "./assets/images/viper-avatar.png",
    avatarHover: "./assets/images/viper-avatar-hover.png",
    class: "./assets/images/controller.svg",
    bio: "Joining from the U.S.A., Brimstone's orbital arsenal ensures his squad always has the advantage. His ability to deliver utility precisely and safely make him the unmatched boots-on-the-ground commander.",
    skills: {
      attack: 5,
...

  {
    ...
    avatar: "./assets/images/omen-avatar.png",
    avatarHover: "./assets/images/omen-avatar-hover.png",
    class: "./assets/images/controller.svg",
...

  {
    ...
    avatar: "./assets/images/killjoy-avatar.png",
    avatarHover: "./assets/images/killjoy-avatar-hover.png",
...

  {
    ...
    avatar: "./assets/images/cypher-avatar.png",
    avatarHover: "./assets/images/cypher-avatar-hover.png",
    class: "./assets/images/sentinel.svg",
...

  {
    ...
    avatar: "./assets/images/sova-avatar.png",
    avatarHover: "./assets/images/sova-avatar-hover.png",
...

  {
    ...
    avatar: "./assets/images/sage-avatar.png",
    avatarHover: "./assets/images/sage-avatar-hover.png",
    class: "./assets/images/sentinel.svg",
...

  {
    ...
    avatar: "./assets/images/phoenix-avatar.png",
    avatarHover: "./assets/images/phoenix-avatar-hover.png",
...

  {
    ...
    avatar: "./assets/images/jett-avatar.png",
    avatarHover: "./assets/images/jett-avatar-hover.png",
    class: "./assets/images/duelist.svg",
...

  {
    ...
    avatar: "./assets/images/reyna-avatar.png",
    avatarHover: "./assets/images/reyna-avatar-hover.png",
    class: "./assets/images/duelist.svg",
...

  {
    ...
    avatar: "./assets/images/raze-avatar.png",
    avatarHover: "./assets/images/raze-avatar-hover.png",
    class: "./assets/images/duelist.svg",
...

  {
    ...
    avatar: "./assets/images/breach-avatar.png",
    avatarHover: "./assets/images/breach-avatar-hover.png",
    class: "./assets/images/initiator.svg",
...

  {
    ...
    avatar: "./assets/images/skye-avatar.png",
    avatarHover: "./assets/images/skye-avatar-hover.png",
    class: "./assets/images/initiator.svg",
...

  {
    ...
    avatar: "./assets/images/yoru-avatar.png",
    avatarHover: "./assets/images/yoru-avatar-hover.png",
    class: "./assets/images/duelist.svg",
...

  {
    ...
    avatar: "./assets/images/astra-avatar.png",
    avatarHover: "./assets/images/astra-avatar-hover.png",
    class: "./assets/images/controller.svg",
...

  {
    ...
    avatar: "./assets/images/kayo-avatar.png",
    avatarHover: "./assets/images/kayo-avatar-hover.png",
    class: "./assets/images/initiator.svg",
...

  {
    ...
    avatar: "./assets/images/chamber-avatar.png",
    avatarHover: "./assets/images/chamber-avatar-hover.png",
    class: "./assets/images/sentinel.svg",
...

  {
    ...
    avatar: "./assets/images/neon-avatar.png",
    avatarHover: "./assets/images/neon-avatar-hover.png",
    class: "./assets/images/duelist.svg",
...

  {
    ...
    avatar: "./assets/images/fade-avatar.png",
    avatarHover: "./assets/images/fade-avatar-hover.png",
    class: "./assets/images/initiator.svg",
...

  {
    ...
    avatar: "./assets/images/harbor-avatar.png",
    avatarHover: "./assets/images/harbor-avatar-hover.png",
    class: "./assets/images/controller.svg",
...

  {
    ...
    avatar: "./assets/images/gekko-avatar.png",
    avatarHover: "./assets/images/gekko-avatar-hover.png",
    class: "./assets/images/initiator.svg",
...

  {
    ...
    avatar: "./assets/images/deadlock-avatar.png",
    avatarHover: "./assets/images/deadlock-avatar-hover.png",
    class: "./assets/images/duelist.svg",
...

  {
    ...
    avatarHover: "./assets/images/iso-avatar-hover.png",
    class: "./assets/images/duelist.svg",
...

  {
    ...
    avatarHover: "./assets/images/clover-avatar-hover.png",
    class: "./assets/images/controller.svg",
